...
function enterKey(e) {
  ...
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine("[sha@archrx5500m]~$" + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=shashanka265@gmail.com"> shashanka265@gmail.com</a>...',
        "color2",
        80,
      );
      newTab(email);
